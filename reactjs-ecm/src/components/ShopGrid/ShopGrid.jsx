  ...
  return (
    <div className="w-full text-[#006532]">
      ...
      <section id="page-header" className="h-[292px] bg-cover bg-center bg-no-repeat"
        ...
        <div className="flex h-full w-full items-center justify-center bg-opacity-70 bg-[rgba(8,28,14,0.69)] text-white">
      ...
      {/* Product list */}
      <section id="product-list" className="py-10">
        <div className="mx-auto grid max-w-[1200px] grid-cols-1 gap-6 px-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
