...
//       <section
//         id="newsletter"
//         className="mt-8 flex flex-wrap items-center justify-between bg-[#041e42] bg-[url(src/assets/images/b14.png)] bg-[20%_30%] bg-no-repeat p-4"
//       >
...
//             Nhận cập nhật qua email về các sản phẩm mới nhất và các ưu đãi đặc
//             biệt của chúng tôi.
//           </p>
//         </div>
//         <div className="form mt-4 flex w-full md:mt-0 md:w-1/2">
//           <input
//             type="text"
//             placeholder="Địa chỉ email của bạn"
//             className="h-[3.125rem] w-full rounded-l border border-transparent px-5 text-[14px]"
//           />
//           <button className="flex h-[3.125rem] flex-shrink-0 items-center justify-center rounded-l-none bg-[#088178] px-4 text-white">
//             Đăng ký
//           </button>
//         </div>
//       </section>
