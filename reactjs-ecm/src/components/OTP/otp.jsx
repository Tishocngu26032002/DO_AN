...
function OTPPage() {
    ...
    const { mutate } = useMutation({
        mutationFn: async (data) => {
            const response = await apiClient.patch("/register-module", {
                email,
                otp: data.otp,
            });
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-6">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            className="h-11 w-full rounded-md bg-gray-100 pl-3 text-base outline-none shadow-sm transition-all ease-out focus:shadow-lg focus:ring-2 focus:ring-[#ac8ece]"
                        />
                        {errors.otp && (
