...
function Home() {
  ...
  return (
    <div className="body w-full">
      <Header />
      <section className="hero flex h-[90vh] w-full flex-col items-start justify-center bg-[url('/images/hero4.jpg')] bg-cover bg-[top_25%_right_0] px-[80px] tablet:h-[70vh] tablet:bg-[top_30%_right_30%] tablet:px-[80px] mobile:bg-custom mobile:px-[20px] mobile:py-[0px]">
