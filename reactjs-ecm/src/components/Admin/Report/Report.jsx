      ...
      <div className="min-h-screen bg-gray-50 p-8">
        <div className="mb-8">
          ...
          <div className="mb-6 flex space-x-4">
            <button className="shadow-md rounded-lg border bg-[#006532] p-2 text-white hover:bg-[#004d26]">
              Tuần
            </button>
            <button className="shadow-md rounded-lg border bg-[#006532] p-2 text-white hover:bg-[#004d26]">
              Tháng
        ...
        <div className="mb-8 grid grid-cols-2 gap-6 md:grid-cols-4">
          <div className="shadow-lg rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="text-3xl font-bold text-[#006532]">
              {revenueData[revenueData.length - 1].revenue} VND
            </p>
          ...
          <div className="shadow-lg rounded-lg border border-gray-200 bg-white p-6">
            ...
            <p className="text-sm text-gray-500">
              So với quý trước: +10 khách hàng
            </p>
          </div>
          <div className="shadow-lg rounded-lg border border-gray-200 bg-white p-6">
            <h4 className="text-xl font-semibold text-[#006532]">Đơn hàng</h4>
            <p className="text-3xl font-bold text-[#006532]">
              {topCustomersData.reduce((acc, curr) => acc + curr.orders, 0)}
            </p>
            <p className="text-sm text-gray-500">
              So với năm trước: +50 đơn hàng
            </p>
          </div>
        </div>
